...
${BTN_LOGIN}                   xpath=//android.widget.Button[@content-desc="Home"]/android.widget.ImageView
${ACCOUNT}                     accessibility_id=Account
${ACCOUNT_NAME}                id=com.google.android.youtube:id/button
${TRENDING_BTN}                accessibility_id=Trending
${10_ITEN}                     xpath=//android.view.ViewGroup[@content-desc="A Capitol Fourth 2021 | PBS - 2 hours - Go to channel - PBS - 271K views - Streamed 1 day ago - play video"]/android.view.ViewGroup/android.view.ViewGroup[1]/android.widget.FrameLayout                         
